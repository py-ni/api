...
class Long:
    ...
    def FromInt64(val: int64_t) -> Self: ...

    def FromUInt64(val: int64_t) -> Self: ...
...
class Str:
    ...
    def FromUtf8String(data: utf_string, length: uintptr_t)  -> Self: ...
...
class StrBuilder:
    ...
    def AppendUtf8String(Self, s:utf_string, size:uintptr_t) -> Void: ...
...
class Object:
    ...
    def Str_func(obj) -> Str: ...
    Str_func.__name__ = 'Str'
...
class Exception:
    ...
    def New(cls: Class, message) -> Self: ...

    def New_s(cls: Class, message: utf_string_z) -> Self: ...

    @no_fail
    def Fatal(message: utf_string_z) -> Void: ...

    def FromErrnoWithFilename(cls: Class, filename: utf_string_z): ...

    def RaiseNew(cls: Class, message: utf_string_z):
    ...
    def Warn(category, message: utf_string_z, stack_level: int) -> Void: ...
...
class Call:
    ...
    def Method(name, args: [object], nargsf: intptr_t, kwnames: Tuple): ...
