...
/* typedefs for generate.objects */
typedef struct PyLongRef PyLongRef;
typedef struct PySequenceRef PySequenceRef;
typedef struct PyTupleRef PyTupleRef;
typedef struct PyDictRef PyDictRef;
typedef struct PyListRef PyListRef;
...
typedef struct PyStrRef PyStrRef;
typedef struct PyClassRef PyClassRef;
typedef struct PyBytesRef PyBytesRef;
typedef struct PyStrBuilderRef PyStrBuilderRef;
typedef struct PyTupleBuilderRef PyTupleBuilderRef;
typedef struct PyExceptionRef PyExceptionRef;
...
typedef void (*PyNI_Setter_FuncPtr)(PyContext ctx, PyRef obj, FieldDescriptor field, void* data, PyRef value);

typedef struct StructLayout StructLayout;
typedef void (*PyNI_CFunctionPointer_FuncPtr)(PyContext ctx);
...
struct PyLongRef {intptr_t _bits;};
PyLongRef PyNI_Long_FromInt32(PyContext ctx, int32_t val);

PyLongRef PyNI_Long_FromUInt32(PyContext ctx, int32_t val);

PyLongRef PyNI_Long_FromInt64(PyContext ctx, int64_t val);

PyLongRef PyNI_Long_FromUInt64(PyContext ctx, int64_t val);
...
struct PySequenceRef {intptr_t _bits;};
...
struct PyTupleRef {intptr_t _bits;};
...
struct PyDictRef {intptr_t _bits;};
PyRef PyNI_Dict_Get(PyContext ctx, PyDictRef self, PyRef key, PyRef default_);
...
struct PyListRef {intptr_t _bits;};
...
struct PyStrRef {intptr_t _bits;};
PyStrRef PyNI_Str_FromUtf8String(PyContext ctx, const Utf8String data, uintptr_t length);
...
struct PyClassRef {intptr_t _bits;};
...
struct PyBytesRef {intptr_t _bits;};
...
struct PyStrBuilderRef {intptr_t _bits;};
...
int PyNI_StrBuilder_AppendUtf8String(PyContext ctx, PyRef Self, const Utf8String s, uintptr_t size);
...
struct PyTupleBuilderRef {intptr_t _bits;};
...
PyStrRef PyNI_Object_ASCII(PyContext ctx, PyRef obj);
...
PyRef PyNI_Call_Method(PyContext ctx, PyRef name, PyRef args[], intptr_t nargsf, PyTupleRef kwnames);
...
struct PyCodeRef {intptr_t _bits;};
...
struct PyFrameStackRef {intptr_t _bits;};
